          ...
          >
            <section className="space-y-8 text-sm text-text-muted leading-relaxed">
              <div className="space-y-3">
                ...
                <p>
                  A Twitch offline banner — also called an offline screen — is
                  the image your channel displays when you are not live. Every
                  visitor who lands on your Twitch page while you are offline
                  sees this image. It is one of the most important branding
                  assets on your channel because it creates a first impression
                  for new followers and communicates professionalism to
                  returning viewers.
                </p>
                <p>
                  A well-designed Twitch banner includes your channel name in
                  large text, an offline message (such as &ldquo;Offline&rdquo;
                  or &ldquo;BRB&rdquo;), your streaming schedule if consistent,
                  and optionally your Discord or social media handles. Keep the
                  design clean and readable — it will be displayed at various
                  sizes across desktop and mobile.
                </p>
              </div>
              ...
              <div className="space-y-3">
                    ...
                    <tbody>
                      {[
                        ...
                        [
                          "Best format",
                          "JPG or PNG",
                          "JPG for photos, PNG for flat graphics",
                        ],
                        [
                          "Minimum size",
                          "1024×576px",
                ...
                <p>
                  This tool exports your Twitch banner at exactly 1920×1080px as
                  JPG at 92% quality — the standard for Twitch uploads. The
                  output file is typically 200–500KB, well within Twitch&apos;s
                  10MB limit.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <ol className="list-decimal list-inside space-y-2 pl-1">
                  <li>
                    ...
                    — choose a template, edit the channel name and offline
                    message, set your background color or upload a custom image.
                  </li>
                  <li>
                    <strong className="text-text-main">Download</strong> — click
                    Download Banner to save the 1920×1080px JPG file.
                  </li>
                  <li>
                    <strong className="text-text-main">Upload to Twitch</strong>{" "}
                    — go to your Twitch{" "}
                    <strong>Creator Dashboard → Settings → Channel</strong> →
                    scroll to <strong>Offline Channel Image</strong> → click
              ...
              <div className="space-y-3">
                ...
                <ul className="list-disc list-inside space-y-2 pl-1">
                  <li>
                    ...
                    Your channel name should be readable in 3 seconds. Dark
                    background + bright text (white, yellow, or Twitch purple)
                    works consistently.
                  </li>
                  <li>
                    <strong className="text-text-main">
                    ...
                    If you stream on fixed days (e.g., Mon/Wed/Fri 8PM EST), add
                    it to your banner. Viewers who discover you offline will
                    know when to return.
                  </li>
                  <li>
                    <strong className="text-text-main">
                      Add a Discord or social CTA.
                    </strong>{" "}
                    A simple &ldquo;Join Discord: discord.gg/yourserver&rdquo;
                    line converts offline visitors into community members.
                  </li>
                  <li>
                    <strong className="text-text-main">
                      Keep branding consistent.
                    </strong>{" "}
                    Use the same color palette as your stream overlay and
                    panels. Consistent branding across your Twitch page looks
                  ...
                  <li>
                    ...
                    Create a special banner for charity streams, subathons, or
                    milestones. Rotating banners keep the channel feeling
                    active.
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-3">
                ...
                <p>
                  Twitch accepts files up to 10MB. A 1920×1080px JPG from this
                  tool is typically 200–500KB — far under the limit. If you
                  upload a PNG background image and the output is larger than
                  expected, use{" "}
                  <Link
