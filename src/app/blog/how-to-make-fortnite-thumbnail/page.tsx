      ...
      <article>
        <header className="mb-10">
          ...
          <p className="text-lg text-text-muted leading-relaxed">
            Fortnite thumbnails have a distinct visual language — bright neon
            colors, dramatic character poses, bold outlined text. Getting this
            right is the difference between a thumbnail that gets scrolled past
            and one that earns the click. Here is the complete guide.
          </p>
        </header>
        ...
        <div className="space-y-10 text-text-main leading-relaxed">
          <section className="space-y-4">
            ...
            <p className="text-text-muted">
              ...
              aspect ratio), and Fortnite thumbnails are no exception. Designing
              at any other size means YouTube will scale or crop your image —
              text becomes blurry, characters lose detail.
            </p>
            <div className="bg-surface border border-border rounded-xl p-5 text-sm space-y-2">
              ...
              {[
                ...
                [
                  "Safe zone for text",
                  "Keep text within center 80% — edges get cropped on some devices",
                ],
              ].map(([label, value]) => (
          ...
          <section className="space-y-4">
            ...
            <p className="text-text-muted">
              Fortnite thumbnails follow a recognizable formula that the biggest
              gaming channels have refined over millions of impressions.
              Understanding why this formula works helps you apply it without
              copying anyone directly.
            </p>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3">
              {[
                {
                  step: "Step 1",
                  title: "Open the Fortnite Thumbnail Maker",
                  desc: "Go to ClickThumb's Fortnite Thumbnail Maker. The canvas is pre-set to 1280×720. Choose a template that matches your video's energy — intense, funny, or challenge-style.",
                },
                {
                  step: "Step 2",
                  title: "Set your background",
                  desc: "Upload a screenshot from your Fortnite session as the background — a dramatic storm circle, a Victory Royale moment, or a high-action firefight. Or use a solid neon color for a clean graphic look.",
                },
                {
                  step: "Step 3",
                  title: "Add your title text",
                  desc: "Keep it short: '100 Eliminations in 1 Game' becomes '100 Kills'. The text should communicate the hook, not the full title. Use the font selector to pick a bold, heavy-weight font.",
                },
                {
                  step: "Step 4",
                  title: "Check readability at small size",
                  desc: "Zoom out your browser until the thumbnail preview is about 120px wide. If you can read the text and identify the character, it will work on mobile. If not, increase font size or reduce text.",
                },
                {
                  step: "Step 5",
                  title: "Download",
                  desc: "Click Download Thumbnail. Exports at full 1280×720 resolution as JPG, under 500KB, ready to upload to YouTube directly.",
                },
              ].map(({ step, title, desc }) => (
                <div
                  key={step}
          ...
          <section className="space-y-4">
            ...
            <p className="text-text-muted">
              Color is the most important single variable in Fortnite thumbnail
              performance. Here is how top channels use it:
            </p>
          ...
          <section className="space-y-4">
            ...
            <p className="text-text-muted">
              Fortnite content covers more than battle royale. Each content type
              has a different audience expectation — matching your thumbnail
              style to the content type increases click-through rate because
              viewers immediately understand what they are getting.
            </p>
            <div className="space-y-3">
              {[
                {
              ...
              {[
                {
                  ...
                  fix: "Cut the title to 3–5 words maximum. Everything else goes in the video title, not the thumbnail.",
                },
                {
                  mistake: "Character too small",
                  fix: "The character or face should occupy at least 40% of the canvas height. Small characters lose all impact at mobile thumbnail size.",
                },
                {
                  mistake: "Using in-game HUD screenshots",
                  fix: "Crop out the health bar, ammo counter, and map. Clean backgrounds make the character and text stand out.",
                },
                {
                  mistake: "Inconsistent style",
                  fix: "Use the same template, font, and color scheme across your channel. Consistency builds recognition — viewers click channels they recognize.",
                },
              ].map(({ mistake, fix }) => (
                <div
                  key={mistake}
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4">
              {[
                {
                  q: "What size should a Fortnite YouTube thumbnail be?",
                  a: "1280×720 pixels (16:9). This is YouTube's recommended size for all thumbnails. Design at this resolution and export as JPG or PNG under 2MB.",
                },
                {
                  q: "Do I need Photoshop to make Fortnite thumbnails?",
                  a: "No. Browser-based tools like ClickThumb are pre-configured at 1280×720 with Fortnite-style templates. You can create a complete thumbnail in under two minutes with no design software.",
                },
                {
                  q: "Should I use my face or a Fortnite character in the thumbnail?",
                  a: "Both work. Face + character thumbnails tend to outperform character-only thumbnails because faces trigger emotional recognition. If you play face-cam, overlay your reaction next to the character.",
                },
                {
                  q: "What font works best for Fortnite thumbnails?",
                  a: "Heavy, condensed fonts with high weight — Impact, Anton, Bebas Neue, or Black Han Sans. Always add a dark outline or shadow so text reads over any background.",
                },
                {
                  q: "How do I get more clicks on my Fortnite thumbnails?",
                  a: "Test one variable at a time: try a different background color, change the text hook, or swap character pose. Check YouTube Studio CTR data after 48 hours. The thumbnail with higher CTR wins — replace the other.",
                },
                {
                  q: "How long should I spend making a Fortnite thumbnail?",
                ...
                {
                  q: "Should every Fortnite video have a unique thumbnail?",
                  a: "Yes. Channels using auto-generated YouTube thumbnails (random screenshots from the video) consistently underperform compared to channels with custom thumbnails. With a template tool, custom Fortnite thumbnails take 5–10 minutes per video — there is no reason not to use one.",
                },
                {
                  q: "What makes Fortnite thumbnails different from other gaming thumbnails?",
                  a: "Fortnite thumbnails are brighter and more saturated than most gaming thumbnails. The game's visual identity is neon and colorful — thumbnails that match this palette feel native to Fortnite. COD uses dark tactical colors, CS2 uses blue or orange on black, Minecraft uses green and brown. Fortnite thumbnails stand out in YouTube feeds because they are designed to be louder and more colorful than almost any other gaming genre.",
                },
              ].map(({ q, a }) => (
                <div
                  key={q}
