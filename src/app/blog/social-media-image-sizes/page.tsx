      ...
      <article>
        <header className="mb-10">
          ...
          <p className="text-lg text-text-muted leading-relaxed">
            Upload the wrong size and platforms crop your design, compress it
            aggressively, or display it blurry. This guide lists the exact pixel
            dimensions for every image type on every major platform — updated
            for 2026.
          </p>
        </header>
        ...
        <div className="space-y-10 text-text-main leading-relaxed">
              ...
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="bg-white">
                    <th className="text-left p-2.5 border border-border font-semibold">
                      Platform
                    </th>
                    <th className="text-left p-2.5 border border-border font-semibold">
                      Image type
                ...
                <tbody>
                  {[
                    ...
                    >
                      <td className="p-2.5 border border-border font-medium text-xs">
                        {platform}
                      </td>
                      <td className="p-2.5 border border-border text-xs">
                        {type}
                      </td>
                      <td className="p-2.5 border border-border font-mono text-xs">
                        {size}
                      </td>
                      <td className="p-2.5 border border-border text-xs">
                        {ratio}
          ...
          <section>
            ...
            <p>
              YouTube is the second largest search engine in the world. Getting
              image sizes right directly affects thumbnail CTR and channel
              discoverability.
            </p>
            <div className="mt-4 space-y-3">
              <div className="border border-border rounded-xl p-4">
                ...
                <p className="text-text-muted text-sm">
                  16:9 ratio, max 2MB, JPG or PNG. The most important image on
                  YouTube — thumbnails directly drive click-through rate. Use
                  bold text (3–5 words), high contrast, and a human face for
                  maximum CTR.
                </p>
                <Link
              ...
              <div className="border border-border rounded-xl p-4">
                ...
                <p className="text-text-muted text-sm">
                  The full banner size is 2560×1440px, but safe zone for all
                  devices is the central 1546×423px. Keep all important content
                  (logo, tagline) within the safe zone. YouTube crops the banner
                  differently on TV, desktop, tablet, and mobile.
                </p>
                <Link
          ...
          <section>
            ...
            <p>
              Instagram supports multiple aspect ratios in the feed. The
              platform re-compresses all uploaded images — using JPG at quality
              85–90 before upload minimizes visible compression artifacts after
              Instagram processes the image.
            </p>
            <div className="mt-4 space-y-3">
              {[
                {
          ...
          <section>
            ...
            <div className="space-y-3 mt-4">
              <div className="border border-border rounded-xl p-4">
                ...
                <p className="text-text-muted text-sm">
                  3:1 ratio. Displays behind your profile photo, which covers
                  the bottom-left corner. Keep important content away from the
                  bottom-left 20% of the banner.
                </p>
                <Link
              ...
              <div className="border border-border rounded-xl p-4">
                ...
                <p className="text-text-muted text-sm">
                  16:9 ratio for single image tweets. Twitter crops the preview
                  in the timeline — the full image is only shown when clicked.
                  Design so the center of the image communicates the key message
                  at the cropped preview size.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-3 mt-4">
              <div className="border border-border rounded-xl p-4">
                ...
                <p className="text-text-muted text-sm">
                  4:1 ratio. Displays differently on desktop vs mobile — desktop
                  shows more width, mobile crops to a narrower center strip.
                  Keep all text and logos in the central 60% of the banner
                  width.
                </p>
                <Link
              ...
              <div className="border border-border rounded-xl p-4">
                ...
                <p className="text-text-muted text-sm">
                  1.91:1 ratio. LinkedIn is primarily a desktop platform, so the
                  full image is more visible than on mobile-first platforms.
                  Text-heavy images perform well on LinkedIn — use PNG for
          ...
          <section>
            ...
            <div className="space-y-3 mt-4">
              <div className="border border-border rounded-xl p-4">
                ...
                <p className="text-text-muted text-sm">
                  Displays at 851×315px on desktop, 640×360px on mobile. Your
                  profile photo overlaps the bottom-left corner on desktop. Keep
                  the central area clear of the profile photo overlap zone.
                </p>
                <a
              ...
              <div className="border border-border rounded-xl p-4">
                ...
                <p className="text-text-muted text-sm">
                  This is also the recommended OG image size — the image that
                  appears when a URL is shared on Facebook. Any page you want to
                  share on Facebook should have an OG image at 1200×630px.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-3 mt-4">
              <div className="border border-border rounded-xl p-4">
                ...
                <p className="text-text-muted text-sm">
                  9:16 full vertical. TikTok is an entirely mobile-first
                  platform — all content is designed for portrait orientation.
                  The profile grid crops covers to a square center, so keep the
                  key visual in the center third.
                </p>
              </div>
              <div className="border border-border rounded-xl p-4">
                <div className="flex items-center justify-between mb-2">
                ...
                <p className="text-text-muted text-sm">
                  2:3 ratio. Pinterest strongly favors vertical images — taller
                  pins take more space in the masonry grid and receive more
                  impressions. The 2:3 ratio is the sweet spot. Avoid going
                  taller than 1:2.1 as Pinterest crops very tall images.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <p>
              Every major social platform re-compresses images when you upload
              them. Instagram, Facebook, Twitter, and LinkedIn all apply their
              own lossy compression to reduce storage and delivery costs. This
              means:
            </p>
            <ul className="list-disc pl-6 mt-3 space-y-2 text-text-muted">
              <li>
                ...
                Uploading a larger image (e.g., 2160×2160px for an Instagram
                post) forces the platform to downsample first, then compress —
                two rounds of quality loss.
              </li>
              <li>
                <strong className="text-text-main">
                  Use JPG at quality 85–90.
                </strong>{" "}
                Starting from an already-compressed file adds platform
                compression on top — quality loss compounds. Start from the
                original or a high-quality export.
              </li>
              <li>
                <strong className="text-text-main">
                  Use PNG for text-heavy designs.
                </strong>{" "}
                JPEG compression introduces blocky artifacts around
                high-contrast text edges. PNG preserves sharp text before the
                platform recompresses it.
              </li>
              <li>
                <strong className="text-text-main">
                  Don&apos;t upload WebP to social media.
                </strong>{" "}
                Most platforms do not accept WebP. Convert to JPG or PNG before
                uploading.
              </li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4">
              Create Images at the Right Size
            </h2>
            <p>
              ClickThumb creates images at exactly the right dimensions for each
              platform — no manual resizing needed.
            </p>
            <ul className="list-disc pl-6 mt-3 space-y-2 text-text-muted">
              <li>
                <Link
