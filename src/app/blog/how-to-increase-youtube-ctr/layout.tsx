...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'How to Increase YouTube CTR: 8 Thumbnail Tips That Work',
    description:
      'Proven thumbnail strategies to improve click-through rate. Contrast, faces, bold text, A/B testing — practical tips for creators.',
    url: PAGE_URL,
  ...
  twitter: {
    ...
    title: 'How to Increase YouTube CTR: 8 Thumbnail Tips',
    description: 'Proven thumbnail strategies to improve your YouTube click-through rate.',
    images: [OG_IMAGE],
  },
}
  ...
  '@graph': [
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Blog', item: 'https://click-thumb.com/blog/' },
        { '@type': 'ListItem', position: 3, name: 'How to Increase YouTube CTR', item: PAGE_URL },
      ],
    },
    {
      '@type': 'Article',
      ...
      author: { '@type': 'Organization', name: 'ClickThumb', url: 'https://click-thumb.com' },
      publisher: {
        '@type': 'Organization',
        name: 'ClickThumb',
