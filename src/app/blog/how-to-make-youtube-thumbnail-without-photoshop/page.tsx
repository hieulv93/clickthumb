    ...
    <main className="max-w-3xl mx-auto px-4 py-12">
      ...
      >
        ...
        <span className="text-text-main">
          Make YouTube Thumbnail Without Photoshop
        </span>
      </nav>
      ...
      <article>
        <header className="mb-10">
          ...
          <p className="text-lg text-text-muted leading-relaxed">
            Most creators assume they need Photoshop — or an expensive
            subscription to a design tool — to make a good YouTube thumbnail.
            They don&apos;t. Modern browser-based canvas editors handle
            everything Photoshop does for thumbnails, and they&apos;re free.
        ...
        <div className="space-y-10 text-text-main leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold">
              Why You Don&apos;t Actually Need Photoshop
            </h2>
            <p className="text-text-muted">
              Photoshop is a professional photo editing suite built for
              photographers and designers. A YouTube thumbnail is a 1280×720px
              image with three elements: a background, a text overlay, and
              sometimes a face or character image. You do not need layer masks,
              frequency separation, or a $20/month subscription to create that.
            </p>
            <p className="text-text-muted">
              The tools top YouTubers use are shifting toward browser-based
              editors precisely because they are faster for this specific task.
              Pick a template that matches your channel aesthetic, swap the
              title text, upload your background photo, and export. Total time:
              under two minutes. That is what most creators actually need, and
              it does not require Photoshop.
            </p>
          ...
          <section className="space-y-4">
            ...
            <p className="text-text-muted">
              Before you design anything, get the technical specs right. YouTube
              has specific requirements, and thumbnails that don&apos;t meet
              them get compressed or cropped.
            </p>
            <div className="bg-surface border border-border rounded-xl p-5 text-sm space-y-3">
              ...
              <p className="text-xs text-text-muted pt-1">
                Always design at 1280×720. If you design at a smaller size and
                scale up, text becomes blurry. If you use a different aspect
                ratio, YouTube adds black bars.
              </p>
            </div>
            <p className="text-text-muted">
              The most important rule: design at 1280×720 from the start, not
              afterward. Scaling up a smaller design introduces blur. A
              browser-based tool like ClickThumb pre-sets the canvas to exactly
              these dimensions, so you never have to think about it.
            </p>
          </section>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold">
              5 Elements Every Great Thumbnail Has
            </h2>
            <p className="text-text-muted">
              Study the top-performing thumbnails across YouTube and you will
              see the same five elements repeated. Not every thumbnail uses all
              five, but knowing them helps you make better choices.
            </p>
          ...
          <section className="space-y-4">
            ...
            <p className="text-text-muted">
              ...
              is a free browser-based canvas editor pre-set to 1280×720. Here is
              the full workflow:
            </p>
            <div className="space-y-4">
              {[
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold">
              5 Design Tips for Higher Click-Through Rate
            </h2>
            <p className="text-text-muted">
              A technically correct thumbnail is not enough — it also has to
              compete with every other thumbnail in the sidebar. These five
              principles make the difference between a thumbnail that gets
              scrolled past and one that gets clicked.
            </p>
