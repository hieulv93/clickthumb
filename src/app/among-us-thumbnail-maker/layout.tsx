...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://click-thumb.com/among-us-thumbnail-maker/",
  },
  openGraph: {
    title: "Among Us Thumbnail Maker — Free Online, No Signup",
    description:
      "Create 1280×720px Among Us thumbnails. Impostor Red, Crewmate Blue, Emergency Meeting templates. Download instantly.",
