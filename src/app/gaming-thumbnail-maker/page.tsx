    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Yes, completely free. No account required. Free downloads include a small watermark — upgrade to Pro to remove it. Create and download unlimited gaming thumbnails.",
          },
        },
        {
          "@type": "Question",
                ...
                <div className="space-y-3">
                  {[
                    ...
                    },
                    {
                      ...
                      a: "Yes, completely free. No account required. Free downloads include a small watermark — upgrade to Pro to remove it. Download unlimited gaming thumbnails at 1280×720px.",
                    },
                    {
