...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://click-thumb.com/fortnite-thumbnail-maker/",
  },
  openGraph: {
    title: "Fortnite Thumbnail Maker — Free Online, No Signup",
    description:
      "Create 1280×720px Fortnite thumbnails. Storm Eye, Zero Point, Legendary Loot templates. Download instantly.",
